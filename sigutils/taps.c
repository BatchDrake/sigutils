...
SUPRIVATE void su_taps_scale(SUFLOAT *h, SUFLOAT k, SUSCOUNT size)
{
  unsigned int i;
...
void su_taps_normalize_Linf(SUFLOAT *h, SUSCOUNT size)
{
  unsigned int i;
  SUFLOAT      max = 0;
...
void su_taps_normalize_L2(SUFLOAT *h, SUSCOUNT size)
{
  unsigned int i;
  SUFLOAT      energy = 0;
...
void su_taps_normalize_L1(SUFLOAT *h, SUSCOUNT size)
{
  unsigned int i;
  SUFLOAT      amplitude = 0;
