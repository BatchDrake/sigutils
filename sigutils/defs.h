...
#define SU_ALLOCATE(dest, type)                \
  SU_ALLOCATE_CATCH(dest, type, goto done)
...
#define SU_ALLOCATE_FAIL(dest, type)           \
  SU_ALLOCATE_CATCH(dest, type, goto fail)
