...
SUPRIVATE unsigned int su_apt_decoder_correlate(su_apt_decoder_t *self,
                                                const SUCOMPLEX  *pat,
                                                unsigned int      start,
                                                unsigned int      end,
                                                SUFLOAT          *snr,
...
SUPRIVATE void su_apt_decoder_update_levels(su_apt_decoder_t *self,
                                            SUBOOL            detected)
{
  unsigned int i;
...
SUPRIVATE SUBOOL su_apt_decoder_flush_line(su_apt_decoder_t *self,
                                           SUBOOL            detected)
{
  uint8_t     *line = NULL;
...
SUPRIVATE void su_apt_decoder_extract_line_until(su_apt_decoder_t *self,
                                                 unsigned int      pos)
{
...
SUINLINE SUSCOUNT su_apt_decoder_pos_to_abs(const su_apt_decoder_t *self,
                                            SUSCOUNT                pos)
{
...
SUPRIVATE SUBOOL su_apt_decoder_perform_search(su_apt_decoder_t *self)
{
  unsigned int pos;
  SUSCOUNT     abs_pos;
  SUFLOAT      snr;
...
void su_apt_decoder_set_snr(su_apt_decoder_t *self, SUFLOAT snr)
{
  self->sync_snr = snr;
}
